Page({
  data: {
    ...
    animationData3: [],     //下方文本2(56小于67)
    animationData4: [],     //下方文本3(56大于53)
    animationData5: [],     //下方文本4(56小于60)
    animationData6: [],     //新插入的树枝
    animationData7: [],     //新插入的结点（结点56）
  ...
  BinaryTreeDisplay: function () {
    ...
    var animation2 = wx.createAnimation({     //下方文本1（插入结点56）
      duration: 600
    })
    var animation3 = wx.createAnimation({     //下方文本1(56小于67)
      duration: 600
    })
    var animation4 = wx.createAnimation({     //下方文本2(56大于53)
      duration: 600
    })
    var animation5 = wx.createAnimation({     //下方文本3(56小于60)
      duration: 600
    })
    var animation6 = wx.createAnimation({     //新插入的树枝
      duration: 600
    })
    var animation7 = wx.createAnimation({     //新插入的结点（结点56）
      duration: 600
    })
