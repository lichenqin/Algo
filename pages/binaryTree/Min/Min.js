Page({
  data: {
    animationData1: [],     //比较箭头
    animationData2: [],     //下方文本1（插入结点20）
    animationData3: [],     //下方文本2(20小于67)
    animationData4: [],     //下方文本3(20小于53)
    animationData5: [],     //下方文本4(20小于45)
    animationData6: [],     //新插入的树枝
    animationData7: [],     //新插入的结点（结点20）
  ...
  BinaryTreeDisplay: function () {
    ...
    var animation2 = wx.createAnimation({     //下方文本1（假设插入结点20）
      duration: 600
    })
    var animation3 = wx.createAnimation({     //下方文本1(20小于67)
      duration: 600
    })
    var animation4 = wx.createAnimation({     //下方文本2(20小于53)
      duration: 600
    })
    var animation5 = wx.createAnimation({     //下方文本3(20小于45)
      duration: 600
    })
    var animation6 = wx.createAnimation({     //新插入的树枝
      duration: 600
    })
    var animation7 = wx.createAnimation({     //新插入的结点（结点20）
      duration: 600
    })
